 ...
 * Maverick Administrators — IFI Portal
 *
...
const AGENCY_GUIDE_CONFIG = {
  ...
  // Used only for the download filename; the agency code is still injected into the PDF.
  ...
  // Set to null to disable. (The site's `agencyCode` identifier is a DOM element, not the code string.)
...
/**
 * Resolves the agency display name from the page via the DOM selector.
 * Returns null if not found so callers can fall back to the agency code.
 */
